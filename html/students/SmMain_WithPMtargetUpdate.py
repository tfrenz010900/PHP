...
smMainVersion = '__SmMain_Ver7a-190626_htc.py'
...
#11/30/18 htc added following fields to local SQL pitch table update
    ...
    VALstring = VALstring + '"' + str(ThisSess_YdeltaPlusMinus3) + '", "' + '-stand-' + '", "' + '-pract-' + '", "' + '-game-' + '", '
    VALstring = VALstring + '"' + '-arcade-' + '", "' + str(CurrPitch_SpinRPM) + '", "' + str(CurrPitch_SpinAxis) + '", "' + CurrPitch_MarqueeContent + '", '
    VALstring = VALstring + '"' + CurrPitch_ExpectedPitch + '", "' + '-*-' + '", "' + CurrPitch_MovementInfo + '", "' + '01/01/1900' + '", '
    VALstring = VALstring + '"' + TargetBoxCoords + '", "' + 'right cam tag' + '", "' + 'left cam tag' + '", "' + 'spin cam tag' + '", '
